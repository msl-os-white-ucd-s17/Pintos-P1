...
{
   // ASSERT (t != NULL)   // Make sure thread is running
	/*
	int divider = intToFixed(divider);
	int dividerMINUSnice = intToFixed(dividerMINUSnice);
	int niceValue = intToFixed(t->nice);
	int multiply = intToFixed(multiply);
	*/
